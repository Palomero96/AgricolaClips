...
(AccionDisponible (nombre "AdquisicionMayor") (turno 1))	;periodo 1
(AccionDisponible (nombre "Vallado") (turno 2))				;periodo 1
(AccionDisponible (nombre "Siembra") (turno 3))				;periodo 1
(AccionDisponible (nombre "MercadoOvino") (turno 4))		;periodo 1
...
(AccionDisponible (nombre "SemillasHortalizas") (turno 8))	;periodo 3
(AccionDisponible (nombre "MercadoPorcino") (turno 9))		;periodo 3
(AccionDisponible (nombre "CanteraOccidental") (turno 10))	;periodo 4
(AccionDisponible (nombre "MercadoBovino") (turno 11))		;periodo 4
